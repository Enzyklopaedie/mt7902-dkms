	       ...
	       struct sk_buff *skb)
{
	...
	if (control->sta) {
		...
		sta = (struct mt7902_mt792x_sta *)control->sta->drv_priv;
		wcid = &sta->wcid;
	}

	if (vif && !control->sta) {
		struct mt7902_mt792x_vif *mvif;

		mvif = (struct mt7902_mt792x_vif *)vif->drv_priv;
		wcid = &mvif->sta.wcid;
	}
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_stop);
			     ...
			     struct ieee80211_vif *vif)
{
	...
	struct mt7902_mt792x_sta *msta = &mvif->sta;
	struct mt7902_mt792x_dev *dev = mt7902_mt792x_hw_dev(hw);
	struct mt7902_mt792x_phy *phy = mt7902_mt792x_hw_phy(hw);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_conf_tx);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_get_stats);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_get_tsf);
...
{
	struct mt7902_mt792x_phy *phy = container_of(timer, struct mt7902_mt792x_phy, roc_timer);
	ieee80211_queue_work(phy->mt76->hw, &phy->roc_work);
}
EXPORT_SYMBOL_GPL(mt7902_mt792x_roc_timer);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_assign_vif_chanctx);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_unassign_vif_chanctx);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_set_wakeup);

static const char mt7902_mt792x_gstrings_stats[][ETH_GSTRING_LEN] = {
	/* tx counters */
	"tx_ampdu_cnt",
	"tx_mpdu_attempts",
	"tx_mpdu_success",
			   ...
			   u32 sset, u8 *data)
{
	...
	memcpy(data, mt7902_mt792x_gstrings_stats, sizeof(mt7902_mt792x_gstrings_stats));

	data += sizeof(mt7902_mt792x_gstrings_stats);
	page_pool_ethtool_stats_get_strings(data);
}
EXPORT_SYMBOL_GPL(mt7902_mt792x_get_et_strings);
			     ...
			     int sset)
{
	...
	return ARRAY_SIZE(mt7902_mt792x_gstrings_stats) +
	       page_pool_ethtool_stats_get_count();
}
EXPORT_SYMBOL_GPL(mt7902_mt792x_get_et_sset_count);
			 ...
			 struct ethtool_stats *stats, u64 *data)
{
	...
	mt7902_mt792x_mac_update_mib_stats(phy);
	...
	ieee80211_iterate_stations_atomic(hw, mt7902_mt792x_ethtool_worker, &wi);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_get_et_stats);
...
void mt7902_mt792x_set_coverage_class(struct ieee80211_hw *hw, int link_id, s16 coverage_class)
{
	struct mt7902_mt792x_phy *phy = mt7902_mt792x_hw_phy(hw);
	struct mt7902_mt792x_dev *dev = phy->dev;
	...
	mt7902_mt792x_mac_set_timeing(phy);

	mt7902_mt792x_mutex_release(dev);
}
EXPORT_SYMBOL_GPL(mt7902_mt792x_set_coverage_class);
...
int mt7902_mt792x_init_wiphy(struct ieee80211_hw *hw)
{
	...
	hw->sta_data_size = sizeof(struct mt7902_mt792x_sta);
	hw->vif_data_size = sizeof(struct mt7902_mt792x_vif);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_init_wiphy);
...
mt7902_mt792x_get_offload_capability(struct device *dev, const char *fw_wm)
{
	...
	data += offset + 16;
	rel_info = (struct mt7902_mt792x_realease_info *)data;
	...
	while (data < end) {
		...
		if (rel_info->tag == MT792x_FW_TAG_FEATURE) {
			struct mt7902_mt792x_fw_features *features;

			features = (struct mt7902_mt792x_fw_features *)data;
			...
			void *drv_data, u8 *fw_features)
{
	...
	*fw_features = mt7902_mt792x_get_offload_capability(dev, drv_data);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_get_mac80211_ops);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_init_wcid);
...
int mt7902_mt792x_mcu_drv_pmctrl(struct mt7902_mt792x_dev *dev)
{
	...
	err = __mt7902_mt792x_mcu_drv_pmctrl(dev);
out:
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_mcu_drv_pmctrl);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_mcu_fw_pmctrl);
...
EXPORT_SYMBOL_GPL(__mt7902_mt792xe_mcu_drv_pmctrl);
...
EXPORT_SYMBOL_GPL(mt7902_mt792xe_mcu_drv_pmctrl);
...
EXPORT_SYMBOL_GPL(mt7902_mt792xe_mcu_fw_pmctrl);
...
EXPORT_SYMBOL_GPL(mt7902_mt792x_load_firmware);
